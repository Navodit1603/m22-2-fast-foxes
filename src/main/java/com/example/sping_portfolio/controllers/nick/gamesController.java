...
import com.example.sping_portfolio.controllers.nick.games;
import com.example.sping_portfolio.controllers.nick.gamesSqlRepository;
...
@Controller
public class gamesController implements WebMvcConfigurer {
    // Autowired enables Control to connect HTML and POJO Object to Database easily for CRUD
    @Autowired
    private gamesSqlRepository repository;

    @GetMapping("/database/person")
    public String person(Model model) {
        List<games> list = repository.listAll();
    ...
    */
    ...
    public String personAdd(games person) {
    ...
    public String personSave(@Valid games person, BindingResult bindingResult) {
    ...
    public String personUpdateSave(@Valid games person, BindingResult bindingResult) {
        // Validation of Decorated PersonForm attributes
        if (bindingResult.hasErrors()) {
            return "database/personupdate";
        }
    ...
    */
    ...
    public ResponseEntity<List<games>> getPeople() {
    ...
    public ResponseEntity<games> getPerson(@PathVariable long id) {
    ...
    public ResponseEntity<Object> postPerson(@RequestParam("email") String email,
        ...
        games person = new games(email, name, dob);
        repository.save(person);
    ...
    public ResponseEntity<Object> personSearch(RequestEntity<Object> request) {
        ...
        List<games> list = repository.listLikeNative(term);
